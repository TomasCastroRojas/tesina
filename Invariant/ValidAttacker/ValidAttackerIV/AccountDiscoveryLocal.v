...
Lemma one_step_account_discovery_local_preserves_valid_attacker_iv : forall (a a' : Attacker) (n: network_map) (aValid: valid_attacker a n) (m : idMachine) (u : idUser) (s: idService),
      valid_concrete_network n -> Pre a (Account_Discovery_Local m u s) -> Post a (Account_Discovery_Local m u s) n a' -> valid_attacker_iv a' n.
  Proof.
