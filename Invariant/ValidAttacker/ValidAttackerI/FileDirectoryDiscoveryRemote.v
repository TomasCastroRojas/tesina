...
Lemma one_step_file_directory_discovery_remote_preserves_valid_attacker_i : forall (a a' : Attacker) (n: network_map) (aValid: valid_attacker a n) (m m': idMachine) (u u': idUser) (k': option key) (p':path) (s': idService),
      valid_concrete_network n -> Pre a (File_Directory_Discovery_Remote m u m' u' k' p' s') -> Post a (File_Directory_Discovery_Remote m u m' u' k' p' s') n a' -> valid_attacker_i a'.
  Proof.
