...
Require Import Invariant.ValidAttacker.ValidAttackerI.FileDirectoryDiscoveryRemote.
...
Require Import Invariant.ValidAttacker.ValidAttackerI.AccountDiscoveryRemote.
Require Import Invariant.ValidAttacker.ValidAttackerI.AbuseElevationControlMechanism.
Require Import Invariant.ValidAttacker.ValidAttackerI.NetworkServiceScanning.
...
Theorem one_step_preserves_valid_attacker_i : forall (a a' : Attacker) (t : Technique) (n: network_map),
  ...
  Proof.
    ...
    - apply (one_step_remote_services_preserves_valid_attacker_i a a' network H0 i i1 i0 i2 o i3); auto.
    ...
    - apply (one_step_brute_force_preserves_valid_attacker_i a a' network H0 i i1 i0 i2 i3); auto.
    - apply (one_step_abuse_elevation_control_mechanism_preserves_valid_attacker_i a a' network H0 i i0); auto.
    - apply (one_step_file_directory_discovery_local_preserves_valid_attacker_i a a' network H0 i i0 p); auto.
    - apply (one_step_file_directory_discovery_remote_preserves_valid_attacker_i a a' network H0 i i1 i0 i2 o p i3); auto.
    - apply (one_step_network_service_scanning_preserves_valid_attacker_i a a' network H0 i i1 i0 l); auto.
    ...
    - apply (one_step_account_discovery_remote_preserves_valid_attacker_i a a' network H0 i i1 i0 i2 o i3); auto.
