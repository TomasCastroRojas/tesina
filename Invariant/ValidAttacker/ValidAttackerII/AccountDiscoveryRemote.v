...
Lemma one_step_account_discovery_remote_preserves_valid_attacker_ii : forall (a a' : Attacker) (n: network_map) (aValid: valid_attacker a n) (m m': idMachine) (u u': idUser) (k' : option key) (s': idService),
      valid_concrete_network n -> Pre a (Account_Discovery_Remote m u m' u' k' s') -> Post a (Account_Discovery_Remote m u m' u' k' s') n a' -> valid_attacker_ii a'.
  Proof.
