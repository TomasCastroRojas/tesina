...
Require Import Invariant.ValidAttacker.ValidAttackerII.AbuseElevationControlMechanism.
Require Import Invariant.ValidAttacker.ValidAttackerII.NetworkServiceScanning.
...
Theorem one_step_preserves_valid_attacker_ii : forall (a a' : Attacker) (t : Technique) (n: network_map),
  ...
  Proof.
    ...
    - apply (one_step_abuse_elevation_control_mechanism_preserves_valid_attacker_ii a a' network H0 i i0); auto.
    ...
    - apply (one_step_network_service_scanning_preserves_valid_attacker_ii a a' network H0 i i1 i0 l); auto.
