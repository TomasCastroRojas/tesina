...
Lemma one_step_brute_force_preserves_valid_attacker_ii : forall (a a' : Attacker) (n: network_map) (aValid: valid_attacker a n) (m m': idMachine) (u u': idUser) (s': idService),
      valid_concrete_network n -> Pre a (Brute_Force m u m' u' s') -> Post a (Brute_Force m u m' u' s') n a' -> valid_attacker_ii a'.
  Proof.
