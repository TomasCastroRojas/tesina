...
Lemma one_step_account_discovery_remote_preserves_valid_attacker_iii : forall (a a' : Attacker) (n: network_map) (aValid: valid_attacker a n) (m m': idMachine) (u u': idUser) (k' : option key) (s': idService),
      valid_concrete_network n -> Pre a (Account_Discovery_Remote m u m' u' k' s') -> Post a (Account_Discovery_Remote m u m' u' k' s') n a' -> valid_attacker_iii a'.
  Proof.
             ...
             ---- split.
                  ----- unfold users_access_to_services in *.
                        ...
                        ------ right.
                               ...
                               pose proof (get_accounts_linked_service_without_key_service u' s' (machine_accounts mac) acc0 Hin_linked) as Hserv_acc0.
                               exists s'. split.
                               ------- exact Hserv_acc0.
                               ------- destruct pre as [_ pre_exists].
                                       destruct pre_exists as [mac_local mac_remote].
                                       destruct mac_remote as [mac_pre [serv_pre [acc_pre [level_pre Hpre_body]]]].
